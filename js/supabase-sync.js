...
const SupabaseSync = (() => {
    ...
    function _diaryToRow(e) {
        return {
            ...
            budget_configured: e.budgetConfigured !== undefined ? e.budgetConfigured : (e.budget_configured !== undefined ? e.budget_configured : null),
    ...
    function _rowToDiary(r) {
        return {
            ...
            budgetConfigured: r.budget_configured,
